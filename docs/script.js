...
function showAns() {
    document.getElementById("aaa").innerHTML = "<p id='bbb'>アーサーとリチャードの喧嘩の際、時計が落ちて壊れた。その時間に止まってしまった。言い合いの後はなにもなく部屋を出た。リチャードは犯人ではない。<br>エレノアはアリバイはないが、怪しい証拠もない。ただ父親が好きなだけ。犯人ではない。<br>ヴィクターはみんなが知らない仕事の秘密を知っているが、今回の事件とは関係がない。犯人ではない。<br>バーバラは時計が止まった9時に散歩をしていたアリバイがあるが、死亡時刻は9時ではないため、そのあと書斎に行って、本棚に隠していた毒薬でアーサーを殺害した。偽造の為ナイフを置いていたが、よく見ると画像のナイフに血は付いていない。バーバラが犯人である。</p>";
}